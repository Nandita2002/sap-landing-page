...
const currItems = [
  "SAP ERP Overview","SAP Architecture","Procurement Process","Inventory Management",
  "MRP Planning","Batch Management","Stock Transfer Orders","Invoice Verification",
  "SAP S/4 HANA & Fiori","Real-Time Projects",
];

...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 text-white py-14 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <ul className="text-slate-300 text-sm space-y-2">
            ...
            <li><a href="#consultation" className="hover:text-white transition">Book Demo</a></li>
      ...
      {/* Bottom */}
      <div className="mt-10 border-t border-slate-700/80 pt-6 text-center pb-24 md:pb-6">
